...
#singularity pull docker://hcibioinformatics/public:MSI_SM_1
container=/uufs/chpc.utah.edu/common/PE/hci-bioinformatics1/TNRunner/Containers/public_MSI_SM_1.sif
