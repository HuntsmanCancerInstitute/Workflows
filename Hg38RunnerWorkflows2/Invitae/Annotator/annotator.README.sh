...
# This fires a variety of apps that annotate a vcf with functional effect info using SnpEff, GNomAD AFs, ClinVar, and the VCFSpliceScanner. 
...
# 2) Copy or soft link your gzipped vcf file to annotate into the job directory naming it anything ending in .vcf.gz. It will be deleted after the run completes!
