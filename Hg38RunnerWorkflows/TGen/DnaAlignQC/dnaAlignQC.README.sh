...
regionsForReadCoverage=$dataBundle/Bed/AvatarV2IDTBedNov2019/hg38IdtSharedProbeTargetCCDSRegions.bed.gz
regionsForOnTarget=$dataBundle/Bed/AvatarV2IDTBedNov2019/hg38IdtProbesPad150bp.bed.gz
...
## e.g. "mkdir SL123; cd SL123"

# 2) Soft link your paired fastq.gz files into the job dir naming them 1.fastq.gz and 2.fastq.gz . Do not copy over, these will be deleted!
## e.g. "ln -s /my/seq/data/SL123_1.fastq.gz 1.fastq.gz; ln -s /my/seq/data/SL123_2.fastq.gz 2.fastq.gz"

# 3) Copy over the workflow docs: xxx.sing, xxx.README.sh, and xxx.sm into the job directory.
## e.g. "cp ~/TNRunner/Workflows/DnaAlignQC/* ."
