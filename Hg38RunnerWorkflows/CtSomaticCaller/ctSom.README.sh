...
#singularity pull docker://hcibioinformatics/public:CtSom_2
container=/uufs/chpc.utah.edu/common/HIPAA/u0028003/HCINix/SingularityBuilds/public_CtSom_2.sif
