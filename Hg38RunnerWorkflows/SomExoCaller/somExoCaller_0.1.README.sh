...
# 4) Create a file named vcfCallFreqConfig.txt containing a single line that defines the data files to scan for prior calling e.g. "fileFilter TAB Hg38/Somatic/Avatar/HA1" 
