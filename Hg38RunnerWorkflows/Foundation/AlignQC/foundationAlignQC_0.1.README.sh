...
# 2) Soft link or move your (Foundation) bam file and it's index into the job dir naming them xxx.bam and xxx.bai 
...
SnakeMakeBioApps_3 < foundationAlignQC_*.udocker

echo -e "\n---------- Complete! -------- $((($(date +'%s') - $start)/60)) min total"

# Final cleanup
mkdir -p RunScripts
mv foundationAlignQC* RunScripts/
mv *.log Logs/
rm -rf .snakemake 
mv slurm* Logs/
