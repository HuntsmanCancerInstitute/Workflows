...
# This tumor capture panel workflow uses Illumina's Manta and Strelka2 variant callers to identify short INDELs and SNVs. It uses a high depth NA12878 bam file in place of a matched normal.  
