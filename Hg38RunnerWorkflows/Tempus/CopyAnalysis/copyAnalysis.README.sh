...
#$singExec pull docker://hcibioinformatics/public:GatkPlus_1
container=/uufs/chpc.utah.edu/common/HIPAA/u0028003/HCINix/SingularityBuilds/public_GatkPlus_1.sif
